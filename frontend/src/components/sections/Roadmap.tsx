    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="relative mt-20 md:mt-28">
          <div
            ref={timelineRef}
            className="absolute left-7 md:left-1/2 md:-translate-x-px top-0 bottom-0 w-px bg-gradient-to-b from-[#CC2200] via-[rgba(204,34,0,0.4)] to-transparent origin-top"
          />
          ...
          <div className="space-y-16 md:space-y-24">
            {ROADMAP_STEPS.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className={`flex-1 ${isLeft ? "md:text-right" : "md:text-left"} ${isLeft ? "md:pr-12" : "md:pl-12"}`}>
