      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 mt-12 md:mt-16">
          {STEPS.map((step, index) => (
            <div
              key={step.number}
              className="process-card relative rounded-2xl p-6 border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] text-center group hover:border-[rgba(204,34,0,0.2)] transition-all duration-500"
            >
